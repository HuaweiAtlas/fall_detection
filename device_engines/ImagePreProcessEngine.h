...
#ifndef ImagePreProcessEngine_H_
#define ImagePreProcessEngine_H_
...
// Define ImagePreProcessEngine
class ImagePreProcessEngine : public Engine {
private:
    const int SEND_BUFFER_SIZE = 1024*1024; //transfer max limit each once:1024KB

public:
    ImagePreProcessEngine():
...
#endif //ImagePreProcessEngine_H_
