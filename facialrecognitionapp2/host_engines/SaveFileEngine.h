...
* @date 2018-5-30
*/
#ifndef SaveFileEngine_ENGINE_H_
#define SaveFileEngine_ENGINE_H_
...
class SaveFileEngine : public Engine {
private:
...
public:
    SaveFileEngine() : postprocess_config_(NULL),has_data_info_file(true),store_path(""){}
    ~SaveFileEngine(){}
...
private:
    ...
    const std::string ENGINE_NAME = "SaveFileEngine";
